...
erlt_elp_df_2014b_long = (
    erlt_elp_df_2014b
        .rename(columns={"CO2EQ": "CO2"})
        .melt(
            id_vars=['Area', 'yearid', 'monthid', 'funclass', 'avgspeed'],
            value_vars=['CO', 'NOX', 'SO2', 'NO2', 'VOC', 'CO2', 'PM10', 'PM25', 'BENZ', 'NAPTH', 'BUTA', 'FORM',
...
erlt_elp_df_2014_long = (
    ...
    .melt(
        ...
        value_vars=['BENZ', 'NAPTH', 'BUTA', 'FORM', 'ACROL', 'DPM', 'POM', 'NOX', 'PM10',
                    'CO2', 'PM25', 'SO2', 'NO2', 'VOC', 'CO'],
        var_name="pollutants",
        value_name="emission_rate_2014",
    )
)

erlt_elp_df_2014_2014b = (
    pd.merge(
...
pollutants_label_value = [
    {"label":pollutant, "value": pollutant} for pollutant in erlt_elp_df_2014_2014b.pollutants.unique()]
avgspeed_values = erlt_elp_df_2014_2014b.avgspeed.unique()
avgspeed_values_marks_dict = {int(avg_speed) if avg_speed % 1 == 0 else avg_speed: f"{avg_speed} mph"
    ...
    html.Div(
        ...
        children=[
            html.Div(
                 ...
                 children=[
                     html.H1("El Paso Emission Rate Look-Up Table Comparison between MOVES 2014 and MOVES 2014b"),
                     dcc.Dropdown(
...
def update_bar_chart(pollutant_val, avgspeed_val):
    erlt_elp_df_2014_2014b_fil = (
        erlt_elp_df_2014_2014b
        .loc[lambda df: (df.pollutants == pollutant_val) & (df.avgspeed ==avgspeed_val)]
