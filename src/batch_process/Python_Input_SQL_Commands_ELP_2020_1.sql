...
DROP SCHEMA IF EXISTS MVS2014b_ERLT;
CREATE SCHEMA MVS2014b_ERLT;
...
flush tables;
drop table  if exists mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate;
create table mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate (SELECT yearid,monthid,hourid,
roadtypeid,pollutantid,sourcetypeid,fueltypeid,avgSpeedBinID,
sum(rateperdistance)as ERate
FROM mvs14b_erlt_elp_48141_2020_1_cer_out.rateperdistance
...
flush tables;
drop table  if exists mvs14b_erlt_elp_48141_2020_1_cer_out.Hourmix;
create table mvs14b_erlt_elp_48141_2020_1_cer_out.Hourmix
SELECT * FROM vmtmix_fy20.hourmix
where District = "Placeholder_District_Name";
...
where TxDOT_Dist = "Placeholder_District_Name" and Daytype = "Weekday" and YearID = 2020;

-- Script to add necessary fields to the rate table and populate it with appropriate data

FLUSH TABLES;
ALTER TABLE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate
...
FLUSH TABLES;
Update mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate
SET Area = "Placeholder_District_Name";
...
FLUSH TABLES;
UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate SET Funclass = "Rural-Freeway" WHERE roadtypeid = 2;

UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate SET Funclass = "Rural-Arterial" WHERE roadtypeid = 3;

UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate SET Funclass = "Urban-Freeway" WHERE roadtypeid = 4;

UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate SET Funclass = "Urban-Arterial" WHERE roadtypeid = 5;
...
CREATE INDEX efidx1
ON mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate
(Period, sourcetypeid, fueltypeid, roadtypeid);

flush tables;
UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate a
JOIN mvs14b_erlt_elp_48141_2020_1_cer_out.VMTmix  b  ON
...
flush tables;
UPDATE mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate a
JOIN mvs14b_erlt_elp_48141_2020_1_cer_out.HourMix c ON
a.hourid = c.TOD
...
--
flush tables;
drop table  if exists MVS2014b_ERLT.temp_erlt_table;
create table MVS2014b_ERLT.temp_erlt_table
...
FROM mvs14b_erlt_elp_48141_2020_1_cer_out.emisrate
GROUP BY Area,yearid,monthid,funclass,avgspeed;

-- Save all the final outputs to MVS2014b_ERLT_OUT schema
CREATE SCHEMA IF NOT EXISTS MVS2014b_ERLT_OUT;
