...
@pytest.mark.parametrize(
    ...
    [
        ({"data" : "running_erlt_intermediate", "fil_county": ["El Paso"]}, {"grp_key": ("El Paso", 2020, 1)}),
        ({"data": "running_erlt_intermediate", "fil_county": ["El Paso"]}, {"grp_key": ("El Paso", 2022, 7)}),
        ({"data": "running_erlt_intermediate", "fil_county": ["El Paso"]}, {"grp_key": ("El Paso", 2024, 10)}),
        ({"data": "running_erlt_intermediate", "fil_county": ["El Paso"]}, {"grp_key": ("El Paso", 2044, 4)}),
    ],
    ids=["_".join(map(str, ("El Paso", 2020, 1))), "_".join(map(str, ("El Paso", 2022, 7))),
         "_".join(map(str, ("El Paso", 2024, 10))), "_".join(map(str, ("El Paso", 2044, 4)))],
    indirect=True
)
def test_final_running_erlt_matches_between_py_sql_v1(get_erlt_running_2014b_data_py, get_py_sql_df_list):
    print(get_py_sql_df_list["grp_key"])
    pd.testing.assert_frame_equal(get_py_sql_df_list["py_erlt_df_fil"], get_py_sql_df_list["sql_erlt_df_fil"])


@pytest.mark.parametrize(
    "get_erlt_running_2014b_data_py", [{"data" : "running_erlt_intermediate", "fil_county": ["El Paso"]}], indirect=True
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"data" : "running_erlt_intermediate_yr_interpolated", "fil_county": ["El Paso"]}, 1),
        ({"data" : "running_erlt_intermediate_yr_spd_interpolated_no_monthid", "fil_county": ["El Paso"]}, 1),
    ],
    ids = ["running_erlt_intermediate", "running_erlt_intermediate_yr_interpolated", "running_erlt_intermediate_yr_spd_interpolated_no_monthid"],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"data" : "running_erlt_intermediate_yr_interpolated", "fil_county": ["El Paso"]}, 0),
        ({"data" : "running_erlt_intermediate_yr_spd_interpolated_no_monthid", "fil_county": ["El Paso"]}, 0),
    ],
    ids=["running_erlt_intermediate", "running_erlt_intermediate_yr_interpolated",
