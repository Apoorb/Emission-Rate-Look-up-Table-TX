...
import functools
import operator
from ttierlt_v1.utils import PATH_INTERIM_EXTNIDLE, get_db_nm_list, connect_to_server_db
from ttierlt_v1.extnidle.extnidle_batch_sql import ExtnidleSqlCmds as erltExtnidle
