...
SET @analysis_year = (SELECT yearid FROM mvs14b_erlt_elp_48141_2022_7_cer_out.ratePerHour LIMIT 1);

FLUSH Tables;
DROP TABLE IF EXISTS mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate;
CREATE TABLE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate
SELECT yearID, monthid, hourID, pollutantID, sourceTypeID, fuelTypeID, processid,sum(ratePerHour) as rateperhour 
FROM mvs14b_erlt_elp_48141_2022_7_cer_out.rateperhour
...
FLUSH Tables;
DROP TABLE IF EXISTS mvs14b_erlt_elp_48141_2022_7_cer_out.hourmix_extidle;
CREATE TABLE mvs14b_erlt_elp_48141_2022_7_cer_out.hourmix_extidle
...
FLUSH Tables;
ALTER TABLE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate
...
FLUSH TABLES;
Update mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate
SET AREA = @analysis_district;

-- Script to add process type group to each MOVES processid

FLUSH TABLES;
UPDATE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate SET Processtype = "Extnd_Exhaust" WHERE Processid in (17,90);
UPDATE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate SET Processtype = "APU" WHERE Processid = 91;
...
BEGIN
   ...
   THEN
		...
		ON mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate 
		...
		flush tables;
		UPDATE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate a
...
UPDATE mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate a
JOIN mvs14b_erlt_elp_48141_2022_7_cer_out.hourmix_extidle b
...
drop table  if exists MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2022_7_cer_out_extnidle_qaqc_from_orignal;
create table MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2022_7_cer_out_extnidle_qaqc_from_orignal
...
FROM mvs14b_erlt_elp_48141_2022_7_cer_out.Extnidlerate
