...
flush tables;
Drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.startrate;
Create table mvs14b_erlt_elp_48141_2044_4_cer_out.startrate (SELECT yearid, monthid,hourid,
pollutantid,sourcetypeid,fueltypeid,sum(rateperstart)as ERate 
FROM mvs14b_erlt_elp_48141_2044_4_cer_out.rateperstart
...
FLUSH TABLES;
drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts;
create table mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts
SELECT hourID,sourceTypeID,fuelTypeID, startsPerVehicle FROM mvs14b_erlt_elp_48141_2044_4_cer_out.startspervehicle;

-- Script to get the TxLED Table.
DELIMITER $$
USE mvs14b_erlt_elp_48141_2044_4_cer_out $$
...
BEGIN
   ...
   THEN
		flush TABLES;
		drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.TxLed_Long_Copy;
		create table mvs14b_erlt_elp_48141_2044_4_cer_out.TxLed_Long_Copy 
		SELECT * FROM txled_db.txled_long
		WHERE yearid = @analysis_year;
				
		ALTER TABLE mvs14b_erlt_elp_48141_2044_4_cer_out.TxLed_Long_Copy
		DROP yearid,
...
FLUSH TABLES;
ALTER TABLE mvs14b_erlt_elp_48141_2044_4_cer_out.startrate
...
ALTER TABLE mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts
ADD COLUMN sumact float,
ADD COLUMN hrmix float;

FLUSH TABLES;
Update mvs14b_erlt_elp_48141_2044_4_cer_out.startrate
...
flush tables;
UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.startrate a
...
flush tables;
UPDATE
mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts as r
JOIN
        ( SELECT   sourceTypeID, fuelTypeID, SUM(startsPerVehicle) as sumact
			FROM mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts a 
...
flush tables;
Update mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts
...
BEGIN
   ...
   THEN
		...
		ON mvs14b_erlt_elp_48141_2044_4_cer_out.startrate 
		(pollutantid, sourcetypeid, fueltypeid);
		
		CREATE INDEX txledidx1
		ON mvs14b_erlt_elp_48141_2044_4_cer_out.TxLed_Long_Copy 
		(pollutantid, sourcetypeid, fueltypeid);
		
		flush tables;
		UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.startrate a
		LEFT JOIN mvs14b_erlt_elp_48141_2044_4_cer_out.TxLed_Long_Copy d ON
...
flush tables;
UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.startrate a
JOIN mvs14b_erlt_elp_48141_2044_4_cer_out.hourmix_starts  b  ON
...
drop table  if exists MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2044_4_cer_out_starts_qaqc_from_orignal;
create table MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2044_4_cer_out_starts_qaqc_from_orignal
...
FROM mvs14b_erlt_elp_48141_2044_4_cer_out.startrate
