...
SET @analysis_year = (SELECT yearid FROM mvs14b_erlt_aus_48453_2020_per_out.movesoutput LIMIT 1);


flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_per_out.idlerate;
create table mvs14b_erlt_aus_48453_2020_per_out.idlerate (SELECT yearid, monthid,hourid,countyid,
linkid,pollutantid,sourcetypeid,fueltypeid,sum(emissionquant)as emission 
FROM mvs14b_erlt_aus_48453_2020_per_out.movesoutput
...
DELIMITER $$
USE mvs14b_erlt_aus_48453_2020_per_out $$
...
BEGIN
   ...
   THEN
		flush TABLES;
		drop table  if exists mvs14b_erlt_aus_48453_2020_per_out.TxLed_Long_Copy;
		create table mvs14b_erlt_aus_48453_2020_per_out.TxLed_Long_Copy 
...
FLUSH TABLES;
ALTER TABLE mvs14b_erlt_aus_48453_2020_per_out.idlerate
...
UPDATE mvs14b_erlt_aus_48453_2020_per_out.idlerate
...
flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_per_out.houridlemix;
create table mvs14b_erlt_aus_48453_2020_per_out.houridlemix (SELECT yearid,monthid,hourid,
linkid,sourcetypeid,fueltypeid,sum(activity)as vmx 
FROM mvs14b_erlt_aus_48453_2020_per_out.movesactivityoutput
...
FLUSH TABLES;
UPDATE mvs14b_erlt_aus_48453_2020_per_out.idlerate A
JOIN mvs14b_erlt_aus_48453_2020_per_out.houridlemix B ON
...
flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_per_out.SUTmix;
create table mvs14b_erlt_aus_48453_2020_per_out.SUTmix 
...
flush tables;
UPDATE mvs14b_erlt_aus_48453_2020_per_out.idlerate a
JOIN mvs14b_erlt_aus_48453_2020_per_out.SUTmix  b ON
...
BEGIN
   ...
   THEN
		...
		ON mvs14b_erlt_aus_48453_2020_per_out.idlerate 
		(pollutantid, sourcetypeid, fueltypeid);
		
		CREATE INDEX txledidx1
		ON mvs14b_erlt_aus_48453_2020_per_out.TxLed_Long_Copy 
		(pollutantid, sourcetypeid, fueltypeid);
		
		flush tables;
		UPDATE mvs14b_erlt_aus_48453_2020_per_out.idlerate a
		LEFT JOIN mvs14b_erlt_aus_48453_2020_per_out.TxLed_Long_Copy d ON
...
drop table  if exists MVS2014b_ERLT_QAQC.mvs14b_erlt_aus_48453_2020_per_out_idling_qaqc_from_orignal;
create table MVS2014b_ERLT_QAQC.mvs14b_erlt_aus_48453_2020_per_out_idling_qaqc_from_orignal
...
FROM mvs14b_erlt_aus_48453_2020_per_out.idlerate
