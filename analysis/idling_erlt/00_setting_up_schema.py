"""
Create the Schemas in MaraDB needed to Output Intermediate data.
...
delete_if_exists_user_input = input(
    ...
    "idling_erlt_intermediate table?(y/n)"
)
if delete_if_exists_user_input.lower() == "y":
    delete_if_exists = True
else:
    delete_if_exists = False
create_idling_table_in_db(delete_if_exists=delete_if_exists)
