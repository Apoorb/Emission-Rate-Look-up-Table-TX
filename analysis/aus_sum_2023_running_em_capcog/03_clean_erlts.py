...
aus_sum_2023_running_out = pd.read_excel(path_aus_sum_2023_running_out,
                                         index_col=0)
...
aus_sum_2023_running_out_1 = (
    aus_sum_2023_running_out
    .set_index(['Area', 'yearid', 'monthid', 'hourid', 'funclass', 'avgspeed'])
    .stack()
    .reset_index()
...
aus_sum_2023_running_out_2 = (
    ...
    .groupby(['Area', 'yearid', 'monthid', 'hourid', 'funclass_red',
              'avgspeed', 'pollutants'])
    .weight_emissions.sum()
    .unstack()
    .reset_index()
    .filter(items=[
        'Area', 'yearid', 'monthid', 'hourid', 'funclass_red', 'avgspeed',
        "CO", "NOX", "NH3", "SO2", "PM10", "PM10_Brakewear",
        "PM10_Tirewear", "PM25", "PM25_Brakewear", "PM25_Tirewear", "VOC",
        "CO2", "Organic_Carbon"
    ])
    .rename(columns={"NOX": "NOx",
                     "PM25": "PM2.5",
