...
erlt_df_2014b = (
    ...
    .melt(
        ...
        value_vars=['CO', 'NOX', 'SO2', 'NO2', 'VOC', 'CO2', 'PM10', 'PM25', 'BENZ',
...
assert set(x1.sheet_names) == set(new_old_district_map.values()), ("Some of the name "
                                                                   "in the previous "
                                                                   "study do not "
                                                                   "match.")
...
for new_district, old_district in new_old_district_map.items():
    ...
    erlt_df_2014_tmp_2 = (
        erlt_df_2014_tmp_1
        .rename(columns={"Road Description": "funclass"})
        .assign(
        ...
        .melt(
            id_vars=[
                ...
                'Road Description',
                'Average Speed (mph)'],
            value_vars=['BENZ', 'NAPTH', 'BUTA', 'FORM', 'ACROL', 'DPM', 'POM', 'NOX',
                        'PM10','CO2', 'PM25', 'SO2', 'NO2', 'VOC', 'CO'],
            var_name="Pollutant",
