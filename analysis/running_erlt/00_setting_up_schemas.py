...
# duplicated data.
delete_running_table_if_exists = input("Do you want to loose the data from previous runs and create a fresh table?(y/n)")
delete_if_exists_user_input = False
if delete_running_table_if_exists.lower() == "y":
    print("Change the delete_if_exists_user_input parameter to True. I am intentionally not automating it.")
    delete_if_exists_user_input = False
