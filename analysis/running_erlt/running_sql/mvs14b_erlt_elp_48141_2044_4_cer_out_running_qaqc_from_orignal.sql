...
flush tables;
drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate;
create table mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate (SELECT yearid,monthid,hourid,
roadtypeid,pollutantid,sourcetypeid,fueltypeid,avgSpeedBinID,
sum(rateperdistance)as ERate 
FROM mvs14b_erlt_elp_48141_2044_4_cer_out.rateperdistance
...
flush tables;
drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.Hourmix;
create table mvs14b_erlt_elp_48141_2044_4_cer_out.Hourmix 
...
flush tables;
drop table  if exists mvs14b_erlt_elp_48141_2044_4_cer_out.VMTmix;
create table mvs14b_erlt_elp_48141_2044_4_cer_out.VMTmix 
SELECT * FROM vmtmix_fy20.todmix 
where TxDOT_Dist = "El Paso" and Daytype = "Weekday" and YearID = 2045;

-- Script to add necessary fields to the rate table and populate it with appropriate data

FLUSH TABLES;
ALTER TABLE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate
...
FLUSH TABLES;
Update mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate
SET Area = "El Paso";
...
FLUSH TABLES;
UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate SET Funclass = "Rural-Freeway" WHERE roadtypeid = 2;

UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate SET Funclass = "Rural-Arterial" WHERE roadtypeid = 3;

UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate SET Funclass = "Urban-Freeway" WHERE roadtypeid = 4;

UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate SET Funclass = "Urban-Arterial" WHERE roadtypeid = 5;
...
CREATE INDEX efidx1
ON mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate 
(Period, sourcetypeid, fueltypeid, roadtypeid);

flush tables;
UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate a
JOIN mvs14b_erlt_elp_48141_2044_4_cer_out.VMTmix  b  ON
...
flush tables;
UPDATE mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate a
JOIN mvs14b_erlt_elp_48141_2044_4_cer_out.HourMix c ON
a.hourid = c.TOD
...
drop table  if exists MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2044_4_cer_out_running_qaqc_from_orignal;
create table MVS2014b_ERLT_QAQC.mvs14b_erlt_elp_48141_2044_4_cer_out_running_qaqc_from_orignal
...
FROM mvs14b_erlt_elp_48141_2044_4_cer_out.emisrate
