...
SET @analysis_district = "Austin";
-- Set districts with TxLED program.
SET @txled_prog_disticts = "Austin,District X"; -- Remove El Paso from here---Check with Madhu---It likely doesn't have TxLED.
SELECT FIND_IN_SET(@analysis_district, @txled_prog_disticts);
SELECT FIND_IN_SET("El Pafso", @txled_prog_disticts);
flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate;
create table mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate (SELECT yearid,monthid,hourid,
roadtypeid,pollutantid,sourcetypeid,fueltypeid,avgSpeedBinID,
sum(rateperdistance) as ERate 
FROM mvs14b_erlt_aus_48453_2020_1_cer_out.rateperdistance
...
SET @analysis_year = (SELECT yearid FROM mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate LIMIT 1);

 
DELIMITER $$
USE mvs14b_erlt_aus_48453_2020_1_cer_out $$
...
flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_1_cer_out.Hourmix;
create table mvs14b_erlt_aus_48453_2020_1_cer_out.Hourmix 
...
flush tables;
drop table  if exists mvs14b_erlt_aus_48453_2020_1_cer_out.VMTmix;
create table mvs14b_erlt_aus_48453_2020_1_cer_out.VMTmix 
...
BEGIN
   ...
   THEN
		flush TABLES;
		drop table  if exists mvs14b_erlt_aus_48453_2020_1_cer_out.TxLed_Long_Copy;
		create table mvs14b_erlt_aus_48453_2020_1_cer_out.TxLed_Long_Copy 
		SELECT * FROM txled_db.txled_long
		WHERE yearid = @analysis_year;
				
		ALTER TABLE mvs14b_erlt_aus_48453_2020_1_cer_out.TxLed_Long_Copy
		DROP yearid,
...
FLUSH TABLES;
ALTER TABLE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate
...
FLUSH TABLES;
Update mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate
...
FLUSH TABLES;
UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate SET Funclass = "Rural-Freeway" WHERE roadtypeid = 2;

UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate SET Funclass = "Rural-Arterial" WHERE roadtypeid = 3;

UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate SET Funclass = "Urban-Freeway" WHERE roadtypeid = 4;

UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate SET Funclass = "Urban-Arterial" WHERE roadtypeid = 5;
...
CREATE INDEX efidx1
ON mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate 
(Period, sourcetypeid, fueltypeid, roadtypeid);

CREATE INDEX vmtidx1
ON mvs14b_erlt_aus_48453_2020_1_cer_out.VMTmix 
(Period, MOVES_STcode, MOVES_FTcode, VMX_RDcode);

flush tables;
UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate a
JOIN mvs14b_erlt_aus_48453_2020_1_cer_out.VMTmix  b  ON
...
ON mvs14b_erlt_aus_48453_2020_1_cer_out.HourMix 
(TOD);

flush tables;
UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate a
JOIN mvs14b_erlt_aus_48453_2020_1_cer_out.HourMix c ON
a.hourid = c.TOD
...
BEGIN
   ...
   THEN
		...
		ON mvs14b_erlt_aus_48453_2020_1_cer_out.TxLed_Long_Copy 
		(pollutantid, sourcetypeid, fueltypeid);
		
		flush tables;
		UPDATE mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate a
		LEFT JOIN mvs14b_erlt_aus_48453_2020_1_cer_out.TxLed_Long_Copy d ON
...
drop table  if exists MVS2014b_ERLT_QAQC.mvs14b_erlt_aus_48453_2020_1_cer_out_running_qaqc_from_orignal;
create table MVS2014b_ERLT_QAQC.mvs14b_erlt_aus_48453_2020_1_cer_out_running_qaqc_from_orignal 
...
FROM mvs14b_erlt_aus_48453_2020_1_cer_out.emisrate
