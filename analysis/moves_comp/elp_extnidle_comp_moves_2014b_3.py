...
if __name__ == "__main__":
    ...
    out_dir2 = r"C:\Users\a-bibeka\PycharmProjects\extnidle_moves_2014b_vs_3\data"
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)
    out_path = os.path.join(out_dir, "extnidle_mvs_2014b_3.csv")
    out_path2 = os.path.join(out_dir2, "extnidle_mvs_2014b_3.csv")
    ...
    for key in mvs3_df.keys():
        for mvs_lab, mvs_df in zip(["MOVES 2014b", "MOVES 3"], [mvs2014b_df, mvs3_df]):
            ...
            extnidle_mvs1 = (
                extnidle_mvs.rename(
                    columns={
                        col: inflection.underscore(col) for col in extnidle_mvs.columns
                    }
                )
                .assign(
                    moves=mvs_lab,
            ...
            assert ~extnidle_mvs1.isna().any().any(), "Check for missing " "values."
            assert ~extnidle_mvs1.isna().any().any(), "Check for missing " "values."
