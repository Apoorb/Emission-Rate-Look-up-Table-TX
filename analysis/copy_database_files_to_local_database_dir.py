...
if __name__ == "__main__":
    ...
    for district_abb in district_abbs:
        ...
        list_of_county_dir = [
            os.path.join(path_to_county_files, file) for file in list_of_dirs
            if re.match(spec_county_files_regex, file)
        ]
        is_num_file_eq_16 = len(list_of_county_dir) == 64
        assert is_num_file_eq_16, ("Check why the file count is not 64; 16 years * 4 "
                                   "months")
    ...
    for district_abb in district_abbs:
        ...
        list_of_prj_dir = [
            os.path.join(path_to_project_files, file) for file in list_of_dirs
        ...
        test_loc = r"C:\Users\A-Bibeka\OneDrive - Texas A&M Transportation " \
    ...
    for db_path in county_db_list:
        ...
        copytree(
            src=db_path,
            dst=os.path.join(mariadb_data_dir, db_nm),
            dirs_exist_ok=True)
